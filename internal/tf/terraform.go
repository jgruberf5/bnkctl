...
func Open(
	...
	backendOverride := filepath.Join(sourceDir, "bnkctl_backend_override.tf")
	backendBody := fmt.Sprintf(`# Generated by bnkctl. Do not edit by hand.
...
// override land cleanly even if a previous bnkctl run initialised
